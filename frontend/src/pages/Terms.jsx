...
export default function Terms() {
  return (
    <div className="max-w-4xl mx-auto p-8 text-gray-700 min-h-[80vh]">
      <h1 className="text-3xl font-bold text-cesi-primary mb-6">Conditions Générales d'Utilisation</h1>
      
      <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 space-y-6 text-justify">
        <section>
        ...
        <div className="pt-6 border-t border-gray-100">
          ...
          <Link to="/register" className="bg-cesi-primary text-white px-6 py-2 rounded-lg font-bold hover:opacity-90 transition inline-block">
